			...
			<form class="uk-form" method="post" action='<?php echo base_url("clientes/registro"); ?>' id="nuevo_cliente">
				<fieldset>
					...
					<div class="uk-grid">
						...
						<div class="uk-width-4-6"><input type="text" class="uk-width-1-1" id="nombre" name="nombre" value="<?php echo set_value('nombre'); ?>" placeholder="Nombre o Raz&oacute;n Social" required></div>
					</div>
					<!-- RFC -->
					<div class="uk-grid">
					...
					<div class="uk-grid">
						...
						<div class="uk-width-3-6"><input class="uk-width-1-1" type="text" id="colonia" name="colonia" value="<?php echo set_value('colonia'); ?>" placeholder="Colonia"></div>
					</div>
					<!-- Localidad -->
					<div class="uk-grid">
						<div class="uk-width-1-6"><label class="uk-form-label" for="localidad">Localidad</label></div>
						<div class="uk-width-3-6"><input class="uk-width-1-1" type="text" id="localidad" name="localidad" value="<?php echo set_value('localidad'); ?>" placeholder="Ciudad o población"></div>
					</div>
					<!-- calle -->
					<div class="uk-grid">
						<div class="uk-width-1-6"><label class="uk-form-label" for="calle">Calle</label></div>
						<div class="uk-width-3-6"><input class="uk-width-1-1" type="text" id="calle" name="calle" value="<?php echo set_value('calle'); ?>" placeholder="Avenida, calle o camino"></div>
					</div>
					...
					<div class="uk-grid">
						...
						<div class="uk-width-3-6"><input class="uk-width-1-1" type="text" id="referencia" name="referencia" value="<?php echo set_value('referencia'); ?>" placeholder="Opcional: Alguna referencia de ubicaci&oacute;n adicional"></div>
					</div>
