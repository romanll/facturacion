...
<html>
	...
	<body>
            ...
            <div class="uk-width-8-10" id="der">
                <div class="uk-container">
                    ...
                    <?php if(isset($emisor)): $emisor=$emisor[0]; ?>
                    	<form class="uk-form" method="post" enctype="multipart/form-data" action='<?php echo base_url("contribuyentes/actualizarf/$emisor->idemisor"); ?>' id="editaremisor">
							<fieldset>
								<!-- validacion -->
								...
								<div class="uk-grid">
									...
									<div class="uk-width-2-6"><input class="uk-width-1-1" type="text" id="pais" name="pais" value="<?php echo set_value('pais',$emisor->pais); ?>" required></div>
		...
		<script src='<?php echo base_url("scripts/contribuyenteseditarf.js"); ?>'></script>
	</body>
</html>