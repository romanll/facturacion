	...
	<body class="uk-height-1-1">
        <div class="uk-vertical-align uk-text-center">
            <div id="box" class="uk-vertical-align-middle uk-container-center">
            	...
            	<div id="cuerpo">
            		<form action="<?php echo base_url("login/acceso"); ?>" class="uk-form" method="post" id="loginform">
            			<div class="uk-grid">
            			...
            			<div class="uk-grid">
            				<div class="uk-width-1-1">
            					<input type="email" id="correo" name="correo" class="uk-width-1-1">
            			...
            			<div class="uk-grid">
            				<div class="uk-width-1-1">
            					<input type="password" id="contrasena" name="contrasena" class="uk-width-1-1">
